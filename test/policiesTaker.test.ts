...
describe("Buy policies", () => {
  ...
  describe("Should buy policies for policy taker 1 in pool 0, 1, 2", () => {
    ...
    it("Should check NFT", async () => {
      ...
      expect((await poolContract0.poolId()).toString() === "0").to.equal(true);
      ...
      expect((await poolContract1.poolId()).toString() === "1").to.equal(true);
      ...
      expect((await poolContract2.poolId()).toString() === "2").to.equal(true);
