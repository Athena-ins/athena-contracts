...
describe("Position Manager", function () {
   ...
   *
   */
  describe.skip("ATEN LP & Staking amounts ", () => {
  ...
  describe("USD Premium rewards", () => {
    it("Should buy Policy on 1 year protocol 0", async function () {
      ...
      const userInfo = await protocolContract.getInfo(userAddress);
      console.log(
        "Should buy Policy on 1 year protocol 0:>>userInfo:",
        userInfo
      );
    });
    ...
    it("Should withdraw everything and get AAVE rewards", async function () {
      ...
      let userInfo = await protocolContract.getInfo(userAddress);
      console.log(
        "Should withdraw everything and get AAVE rewards:>>userInfo0:",
        userInfo
      );
      ...
      userInfo = await protocolContract.getInfo(userAddress);
      console.log(
        "Should withdraw everything and get AAVE rewards:>>userInfo1:",
        userInfo
      );
      ...
      userInfo = await protocolContract.getInfo(userAddress);
      console.log(
        "Should withdraw everything and get AAVE rewards:>>userInfo2:",
        userInfo
      );
      ...
      console.log("rewardsUser3:", rewardsUser3);
