...
export function EcclesiaDao_votesToTokens() {
  context("votesToTokens", function () {
    before(async function () {
      this.args = {};
    });

    it("should correctly convert votes to ATEN for lock durations smaller than EQUILIBRIUM_LOCK", function () {
    ...
    it("should correctly convert votes to ATEN for lock durations equal to EQUILIBRIUM_LOCK", function () {
    ...
    it("should correctly convert votes to ATEN for lock durations larger than EQUILIBRIUM_LOCK", function () {
    ...
    it("should return zero ATEN when converting zero votes", function () {
    ...
    it("should handle edge cases and boundary values correctly", function () {
