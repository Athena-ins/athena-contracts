...
export function ClaimManager_setKlerosConfiguration() {
  context("setKlerosConfiguration", function () {
    ...
    it("should successfully update the Kleros arbitrator", async function () {
    ...
    it("should successfully update the subcourt ID", async function () {
    ...
    it("should successfully update the number of jurors", async function () {
