...
library VirtualPool {
  ...
  function availableLiquidity(
    ...
    return
      self.overlaps[self.poolId] - self.slot0.totalInsuredCapital;
  }
  ...
  function _coverInfo(
    ...
    (Slot0 memory slot0, ) = _refresh(self, block.timestamp);
   ...
   * @param liquidity_ The total liquidity of the pool
