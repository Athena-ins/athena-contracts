...
interface IStaking is IERC20 {
  ...
  /**
   * @notice get staked Token contract address
   * @return staked contract (address or type for Solidity)
   */
  ...
  /**
   * @notice get the yield bonus amount
   * @param _user user address
   * @return yield bonus amount
   */
  function yieldBonusOf(
    address _user
